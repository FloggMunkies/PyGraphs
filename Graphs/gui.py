...
# TODO differentiate between Directed, Undirected (to and from) edges
# TODO Incorperate Graphing to keep track of nodes and edges for deletion
# TODO Convert WidgetManager data into Json file, Save and Load features
# TODO Add Boxes for Create Mode to have default values for mass similar nodes
#       Ex. (Area="Main gate" since map will likely only be one area) (Textbox should fulfill this)
# TODO Add general settings boxes for each mode (add edges: weight, directed/undirected, uni/bidirectional)
# TODO Add functionality to WidgetManager Edit Mode; (Text, Weight, Directed/Undirected)
# TODO Add functionality to WidgetManager Delete Mode
# TODO Add functionality to WidgetManager Move Mode
# TODO Add Adjacency Matrix (or List) behind the scenes
